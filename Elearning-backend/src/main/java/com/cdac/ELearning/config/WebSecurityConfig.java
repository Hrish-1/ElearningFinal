...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
        		.csrf().disable()
                .authorizeRequests()
                .antMatchers("/course/get","/register","/quiz/get/*","/login","/logout_success","/forgot_password","/reset_password","/quiz/score","/problem/score")
                .permitAll()
                .antMatchers("/users/addCourse","/problem/all","/problem/one").hasAnyAuthority("role_user")
